...
<br>
<form action="http://localhost:8080/wifi/bookmark-group-edit-submit.jsp" method="get">
    ...
    <div style="text-align: center; margin-top: 10px;">
        <a href="http://localhost:8080/wifi/bookmark-group.jsp">돌아가기</a>|<button type="submit">수정</button>
    </div>
